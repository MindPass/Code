...
class Ui_fenetreProgression(object):
    def setupUi(self, fenetreProgression):
        ...
        fenetreProgression.resize(740, 650)
        fenetreProgression.setMinimumSize(QtCore.QSize(740, 650))
        fenetreProgression.setMaximumSize(QtCore.QSize(740, 650))
...
"}")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 721, 515))
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(142, 565, 455, 80))
        self.label.setText("")
