...
"}")
        ...
        self.label_3.setGeometry(QtCore.QRect(950, 20, 211, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.line = QtWidgets.QFrame(self.centralwidget)
        self.line.setGeometry(QtCore.QRect(949, 60, 231, 20))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(950, 70, 221, 30))
        self.lineEdit.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.lineEdit.setObjectName("lineEdit")
        self.categorie1 = QtWidgets.QLabel(self.centralwidget)
        self.categorie1.setGeometry(QtCore.QRect(950, 110, 191, 31))
        font = QtGui.QFont()
...
"}")
    ...
    def retranslateUi(self, fenetreGestion):
        ...
        self.lineEdit_3.setText(_translate("fenetreGestion", "Mot de passe"))
        self.label_4.setText(_translate("fenetreGestion", "Site"))
        self.lineEdit_2.setText(_translate("fenetreGestion", "Identifiant"))
