...
fenetre = Tk()
fenetre.title('Mindpass')

photo=PhotoImage(file="LogoMindPass-512px.png") 
zone_dessin = Canvas(fenetre,width=515,height=90,bg='white',bd=8,relief="ridge") 
zone_dessin.create_image(265,52,image=photo) 
zone_dessin.pack()
